...
def utcnow() -> datetime:
    ...
    SQLAlchemy installations using timezone-naive columns may strip
    the timezone during persistence.
    """
...
class Dataset(Base):
    ...
    tokens_count: Mapped[int] = mapped_column(
        Integer,
        default=0,
    )
...
class TrainingJob(Base):
    ...
    gpu_device: Mapped[str | None] = mapped_column(
        String(128),
        nullable=True,
    )
    ...
    ram_limit: Mapped[str | None] = mapped_column(
        String(64),
        nullable=True,
    )

    vram_limit: Mapped[str | None] = mapped_column(
        String(64),
        nullable=True,
    )
...
class Experiment(Base):
    ...
    gpu_usage: Mapped[dict] = mapped_column(
        JSON,
        default=dict,
    )
...
class GPUMetric(Base):
    ...
    gpu_index: Mapped[int] = mapped_column(
        Integer,
        default=0,
    )
    ...
    vram_usage: Mapped[float] = mapped_column(
        Float,
        default=0,
    )

    vram_total: Mapped[float] = mapped_column(
        Float,
        default=0,
    )
    ...
    power_usage: Mapped[float] = mapped_column(
        Float,
        default=0,
    )
