...
| Original backend regressions | PASS | 598 backend PASS | Local/unit boundaries | Keep all in CI |
...
| Backend coverage ≥80% | FAIL | 54.78% | Insufficient core coverage | Add real tests |
...
| Security Critical=0/High=0 | FAIL | 1 open High; incomplete dynamic/image scope | Global CoE/FinOps scope risk | Fix High and scan actual artifacts |
