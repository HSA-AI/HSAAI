...
export function EntityCard({ entity, onSelect }: { entity: GraphEntity; onSelect: (entity: GraphEntity) => void }) {
  return (
    <button onClick={() => onSelect(entity)} className="w-full rounded-2xl border border-hsa-yellow/20 bg-white p-4 text-start shadow-sm transition hover:border-hsa-yellow dark:bg-hsa-black">
