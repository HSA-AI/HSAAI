...
export default function Error({
  ...
  return (
    <div role="alert" className="flex min-h-[60vh] items-center justify-center bg-hsa-bg p-6">
      <div className="w-full max-w-md space-y-4 rounded-2xl border border-hsa-border bg-white p-8 text-center shadow-hsa-card">
        <span aria-hidden className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-red-50 text-xl text-red-600">⚠</span>
        <h2 className="text-xl font-bold text-hsa-black">حدث خطأ غير متوقع</h2>
        <p className="text-sm leading-7 text-hsa-secondary">
          نعتذر عن الإزعاج. يرجى المحاولة مرة أخرى، أو التواصل مع الدعم الفني
          إذا استمرت المشكلة.
        </p>
        {error.digest && (
          <p className="text-xs text-hsa-secondary">
