...
# FIX v0.1 (P1): Switch default cross-encoder from English-only
# `cross-encoder/ms-marco-MiniLM-L-6-v2` to multilingual
# `BAAI/bge-reranker-v2-m3` — handles Arabic queries properly.
# The old model produced near-random scores for Arabic queries.
_CROSS_ENCODER_MODEL = os.getenv(
    "RERANKER_CROSS_ENCODER",
    "BAAI/bge-reranker-v2-m3",  # FIX v0.1: multilingual (was English-only)
)
