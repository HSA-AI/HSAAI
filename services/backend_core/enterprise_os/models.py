...
class EnterpriseScope:
    """Keep legacy unassigned rows in default/default until ownership review."""
    tenant_id = Column(String(128), index=True, nullable=False, default="default", server_default="default")
    workspace_id = Column(String(128), index=True, nullable=False, default="default", server_default="default")


class AICoEProject(EnterpriseScope, Base):
...
class AIPolicy(EnterpriseScope, Base):
...
class AIRisk(EnterpriseScope, Base):
...
class AITraining(EnterpriseScope, Base):
...
class CostRecord(EnterpriseScope, Base):
...
class Integration(EnterpriseScope, Base):
...
class ConnectorLog(EnterpriseScope, Base):
