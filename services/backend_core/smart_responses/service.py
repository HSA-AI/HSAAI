...
DEFAULT_RESPONSES = [
    ...
    },
    {
        ...
        "match_type": "keyword",
        "response_text": "أنا HSAAI Assistant، المساعد الذكي المؤسسي المصمم لمساعدتك في البحث والمعرفة والإجراءات المؤسسية وتحليل المعلومات.",
        "priority": 900,
    },
    {
...
def detect_response(db: Session, message: str, tenant_id: str, workspace_id: str, user_id: str = "anonymous") -> dict[str, Any]:
    ...
    if not match:
        ...
        db.commit()
        return {"matched": False, "agent": "HSAAI Assistant", "source": "llm", "score": 0.0}
